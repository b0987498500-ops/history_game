...
const CLUE_DATABASE = {
  clue_lin_petition_draft: {
    ...
    icon: '🎩',
    rarity: 'SSR 議會先驅',
    gameplayTip: '👉 前往【州廳公署】遞交議會設置請願書，和平爭取民主自治！',
    historicalLore: '林獻堂自1921年起領導發起共15次請願運動，為日治時期動員最廣之合法民權爭取。',
  ...
  clue_goto_three_surveys: {
    ...
    icon: '🎖️',
    rarity: 'SSR 殖民基盤',
    gameplayTip: '👉 前往【州廳政務署】推動三大基礎調查，確立財政體制。',
    historicalLore: '後藤新平推行土地、戶口與舊慣三大調查，奠定日本在臺殖民統治與財政自立。',
  ...
  clue_jianji_farmer_union: {
    ...
    icon: '🌾',
    rarity: 'SSR 農民先鋒',
    gameplayTip: '👉 前往【製糖工廠公署】抗議壓秤剝削，爭取公道秤重！',
    historicalLore: '1925年二林蔗農事件催生「臺灣農民組合」，帶領廣大蔗農反抗製糖會社壓秤剝削。',
  ...
  clue_candidius_sinkang_script: {
    ...
    icon: '📖',
    rarity: 'SSR 文書開端',
    gameplayTip: '👉 前往【赤崁市集】以羅馬字拼寫母語，簽署新港文書。',
    historicalLore: '荷蘭牧師創製「新港文字」，留存了珍貴的平埔原住民族土地契約文書百餘年。',
    howToGet: '甘治士開局隨身錦囊'
  },
  clue_zhen_soldier_farming: {
    ...
    icon: '🌾',
    rarity: 'SSR 屯墾基業',
    gameplayTip: '👉 前往【軍屯拓荒所】疏浚引水、耕種官田解決軍糧短缺。',
    historicalLore: '明鄭推行軍屯制（如左營、柳營、前鎮等），解決大軍糧荒並開闢農業市街。',
  ...
  clue_guo_liugong_canal: {
    ...
    icon: '💧',
    rarity: 'SSR 水利工藝',
    gameplayTip: '👉 前往【瑠公木梘水圳】架設木梘引水澆灌良田。',
    historicalLore: '郭錫瑠開鑿瑠公圳，以木梘跨越景美溪引新店溪水，奠定臺北盆地農耕基石。',
    howToGet: '郭錫瑠開局隨身錦囊'
  },
  clue_lin_shuangwen_seal: {
    ...
    icon: '🚩',
    rarity: 'SSR 民變風雲',
    gameplayTip: '👉 前往【天地會集結點】高舉義旗抗暴，開倉賑濟鄉民！',
    historicalLore: '林爽文事件為清治時期規模最大民變，乾隆調派大軍平定並賜名諸羅為「嘉義」。',
    howToGet: '林爽文開局隨身錦囊'
  },
  clue_li_chunsheng_tea_export: {
    ...
    icon: '💼',
    rarity: 'SSR 茶金商賈',
    gameplayTip: '👉 前往【寶順茶棧】炭焙精選烏龍茶，直銷歐美市場！',
    historicalLore: '李春生擔任買辦開拓烏龍茶直銷歐美，奠定大稻埕為北臺灣商業樞紐地位。',
    howToGet: '李春生開局隨身錦囊'
  },
  clue_mackay_oxford_college: {
    ...
    icon: '🩺',
    rarity: 'SSR 宣教行醫',
    gameplayTip: '👉 前往【偕醫館】為民眾拔牙行醫，興辦牛津學堂引進西學。',
    historicalLore: '馬偕在臺行醫宣教三十年，設立滬尾偕醫館與全臺首座女子學校牛津學堂。',
    howToGet: '馬偕博士開局隨身錦囊'
  },
  clue_lei_zhen_free_china: {
    ...
    icon: '📰',
    rarity: 'SSR 民主思潮',
    gameplayTip: '👉 前往【自由出版所】發表言論自由社論，力倡憲政民主！',
    historicalLore: '雷震主持《自由中國》呼籲落實憲政與政黨政治，為臺灣戰後民主播下重要種子。',
    howToGet: '雷震開局隨身錦囊'
  },
  clue_dadaocheng_tea: {
    ...
    icon: '📜',
    rarity: 'SSR 必備情報',
    gameplayTip: '👉 前往東北方【寶順洋行】採買深坑烏龍茶，利潤極佳！',
    historicalLore: '陶德將臺灣烏龍茶直銷紐約爆紅，大稻埕躍居臺灣繁榮商港。',
